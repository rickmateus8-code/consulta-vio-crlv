...
export default function CNHPainel() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f7fa] text-[#333] flex flex-col w-full overflow-x-hidden font-sans">
      {/* --- OVERLAY BACKDROP --- */}
      {sidebarOpen && (
        <div
      ...
      {/* --- FULL-WIDTH TOP NAVBAR FOR DESKTOP & MOBILE --- */}
      <header className="bg-[#0a1c40] text-white w-full py-4 shadow-md z-10 sticky top-0">
        <div className="w-full max-w-[600px] mx-auto px-4 flex items-center justify-between">
      ...
      <main className="flex-1 w-full max-w-[600px] mx-auto p-4 py-6 space-y-4 flex flex-col items-center">
      ...
      {/* --- FOOTER LOGOS --- */}
      <footer className="w-full max-w-[600px] mx-auto py-6 px-4 flex justify-center items-center mt-auto">
        <img src="/img/cnh-app/IMG_2339.png" alt="Serpro - CNH do Brasil - Ministério dos Transportes - Governo do Brasil" className="w-full max-w-[360px] h-auto object-contain block" />
      </footer>
