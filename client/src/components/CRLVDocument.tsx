...
async function drawCRLVToCanvas(cvs: HTMLCanvasElement, props: CRLVDocumentProps) {
  ...
  const ufDetran = (props.detranUF || props.emissaoDetranUF || "SP").toUpperCase();
  ...
  drawClippedText(ctx, (props.marcaModeloVersao || "GM/OMEGA GLS").toUpperCase(), marginX, 875, leftW, 38, true);
  ...
  drawClippedText(ctx, (props.especieTipo || "PASSAGEIRO AUTOMOVEL").toUpperCase(), marginX, 980, leftW, 38, true);
  ...
  drawClippedText(ctx, (props.chassi || "9BGVP19BPPB233276").toUpperCase(), marginX + 480, 1085, leftW - 480, 36, true);
  ...
  const hashEmi = props.emissaoDetranHash || "072C1EB4EDB8F41";
  const dataEmiStr = props.emissaoDataHora || "30/05/2025 às 14:11:30";
  ...
  ctx.font = "bold 36px Arial, sans-serif";
  drawClippedText(ctx, (props.motor || "C20NE31022309V").toUpperCase(), rightX, 515, 500, 36, true);
  ...
  drawClippedText(ctx, (props.nome || "ANTONIO CAMILO ALMEIDA FREITAS JUNIOR").toUpperCase(), rightX, 730, rightW, 38, true);
  ...
  ctx.font = "bold 38px Arial, sans-serif";
  drawClippedText(ctx, (props.local || "CURITIBA PR").toUpperCase(), rightX, 950, 700, 38, true);
  ...
  ctx.font = "bold 24px Arial, sans-serif";
  ctx.fillText("★", rightX + 20, dpvatY + 85);
  ctx.fillText("★", rightX + 240, dpvatY + 85);
