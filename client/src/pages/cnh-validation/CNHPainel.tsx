...
export default function CNHPainel() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#e9ecf2] flex flex-col justify-center items-center font-sans">
  ...
  if (error || !record) {
    return (
      <div className="min-h-screen bg-[#e9ecf2] font-sans flex justify-center items-start">
        <div className="w-full max-w-[400px] min-h-screen bg-[#e9ecf2]">
  ...
  return (
    <div className="min-h-screen bg-[#e9ecf2] text-[#333] flex justify-center items-start overflow-x-hidden font-sans">
      <div className="w-full max-w-[400px] min-h-screen bg-[#e9ecf2] flex flex-col relative shadow-sm">
        {/* --- OVERLAY BACKDROP --- */}
        {sidebarOpen && (
          <div
        ...
        >
          <div className="pt-10 px-5 pb-4 border-b border-slate-100 flex flex-col relative bg-white">
            ...
            <div className="font-bold text-[16px] text-[#0a1c40] tracking-tight uppercase">
              {fullNome}
            </div>
        ...
        {/* --- TOP NAVBAR MATCHING REFERENCE SITE --- */}
        <header className="bg-[#0a1c40] text-white p-4 pt-9 pb-5 rounded-b-[20px] shadow-md z-10 flex items-center justify-between sticky top-0">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-[17px] tracking-wide text-white uppercase">
              CNH DO BRASIL
            </span>
          </div>
          <div className="flex items-center gap-4">
            <Bell className="w-5 h-5 text-white cursor-pointer fill-current" />
            <div className="w-9 h-9 rounded-full border border-white/90 flex items-center justify-center text-sm font-normal cursor-pointer text-white uppercase">
              {inicial}
            </div>
          </div>
        </header>
        ...
        <main className="flex-1 w-full p-4 py-6 space-y-4 flex flex-col items-center">
        ...
        <footer className="w-full py-6 px-4 flex justify-center items-center mt-auto bg-[#e9ecf2]">
          <img src="/img/cnh-app/IMG_2339.png" alt="Serpro - CNH do Brasil - Ministério dos Transportes - Governo do Brasil" className="w-full max-w-[320px] h-auto object-contain block" />
        </footer>
        ...
        {modalMsg && (
          <div className="fixed inset-0 bg-black/60 z-[3000] flex items-center justify-center p-4 backdrop-blur-[2px]">
            <div className="bg-white w-[85%] max-w-[320px] rounded-[20px] p-6 text-center shadow-2xl animate-in fade-in zoom-in duration-200">
              ...
              <p className="text-[#0a1c40] text-sm font-semibold leading-relaxed mb-6">
                {modalMsg}
              </p>
              <button
                onClick={() => setModalMsg("")}
