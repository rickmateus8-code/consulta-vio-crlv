    ...
    <DashboardLayout>
      <div className="min-h-screen bg-[#020617] text-white flex flex-col font-sans select-none">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-0">
          {/* COLUNA ESQUERDA: NAVEGAÇÃO DE ABAS & FORMULÁRIO (5/12 cols) */}
          <div className="lg:col-span-5 border-r border-slate-800 bg-[#040914] flex flex-col h-[calc(100vh-4rem-4rem)]">
          ...
          {/* COLUNA DIREITA: PRÉVIA INTERATIVA EM TEMPO REAL (7/12 cols) */}
          <div className="lg:col-span-7 bg-[#020617] flex flex-col h-[calc(100vh-4rem-4rem)] relative overflow-hidden">
            {/* BARRA DE ZOOM */}
